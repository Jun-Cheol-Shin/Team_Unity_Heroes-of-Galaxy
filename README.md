...
#### 담당 : 캐릭터 클라이언트
#### 개발기간 : 5개월
#### [플레이 영상](https://youtu.be/nFbnCIlHbpg)
------------
# 목차
* [게임 소개](#게임-소개)
* [구현 내용](#구현-내용)
...
------------
# 게임 소개
  * [FPS와 RTS 혼합 및 AI 코옵](#FPS와-RTS-혼합-및-AI-코옵)  
  * [몬스터 및 보스](#몬스터-및-보스)
## FPS와 RTS 혼합 및 AI 코옵
...
------------
# 구현 내용
  * [블렌드 트리와 레이어 그리고 애니메이션 이벤트로 애니메이터 제작](#블렌드-트리와-레이어-그리고-애니메이션-이벤트로-애니메이터-제작)
  * [캐릭터 컨트롤러를 이용한 캐릭터 구현](#캐릭터-컨트롤러를-이용한-캐릭터-구현)
  * [3인칭 카메라 콜리전 구현](#3인칭-카메라-콜리전-구현)
  * [IK 시스템 사용](#IK-시스템-사용)
  * [오브젝트 풀링](#오브젝트-풀링)
  * [JSON 데이터 세팅](#JSON-데이터-세팅)
  * [커스텀 에디터](#커스텀-에디터)
  * [스킬 구현](#스킬-구현)
## 블렌드 트리와 레이어 그리고 애니메이션 이벤트로 애니메이터 제작
